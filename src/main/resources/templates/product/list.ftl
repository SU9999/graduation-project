                ...
                <div class="col-md-12 column">
                    <ul class="pagination pagination-sm pull-right">
                        ...
                        <#list 1..productInfoPage.totalPages as index>
                            ...
                            <#elseif index-currentPage lt 9 && productInfoPage.totalPages - index lt 10>
                                <li>
                                <a href="/sell/seller/product/list?page=${index}&size=${size}">${index}</a>
                                </li>
                            </#if>
                        </#list>
                        <#if productInfoPage.totalPages - currentPage gte 9>
                            <li>
                            <a href="/sell/seller/product/list?page=${currentPage+1}&size=${size}">...</a>
                            </li>
                        </#if>
